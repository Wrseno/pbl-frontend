const loadingContianer = document.getElementById("loading-container");

const showSkeleton = async () => {
  loadingContianer.innerHTML = `
  <div class="h-full w-full place-content-center absolute bg-white">
