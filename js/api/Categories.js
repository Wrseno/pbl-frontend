    ...
    try {
      ...
      data.forEach((category) => {
        categoriesContainer.innerHTML += `
                <a
            href="./events?category_id=${category.category_id}"
            class="snap-center shrink-0 flex gap-1 items-center shadow-md p-2 h-10 rounded-xl transition-colors duration-200 hover:bg-blue-100 active:bg-blue-200 border border-blue-500"
          >
            <div
