...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/tailwindcss-datepicker@latest/tailwind-datepicker.min.css">
    <script src="https://cdn.jsdelivr.net/npm/tailwindcss-datepicker@latest/tailwind-datepicker.min.js"></script>
  ...
  <div class="relative mb-5">
    ...
    <div class="absolute top-4 right-4 max-w-sm">
      <div class="relative">
        ...
        <input id="datepicker-actions" type="text" datepicker datepicker-buttons datepicker-autoselect-today class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
      </div>
    </div>
  </div>
...
<!-- event -->
  <div class="container mx-auto mt-20">
    <div class="grid grid-cols-4 gap-10 mt-5">
      <a href="#" class="block max-w-[18rem] p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      <image src="img/tech.jpg" alt="Foto Event" class="w-full h-70 object-cover rounded-md mb-4">
      ...
      <a href="#" class="block max-w-[18rem] p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      <image src="img/tech.jpg" alt="Foto Event" class="w-full h-30 object-cover rounded-md mb-4">
